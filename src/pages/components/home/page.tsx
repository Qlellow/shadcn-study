  ...
  return (
    <ComponentsLayout>
      <div className="min-h-screen pt-12 pb-16">
        ...
        {/* Components Section */}
        <section className="container mx-auto px-4 py-16">
          <h2 className="text-3xl font-bold text-center mb-4">실습 컴포넌트</h2>
            ...
            {components.map((component, index) => {
              ...
              return (
                <Link
                  key={index}
                  to={component.path}
                  className="group block p-6 rounded-lg border bg-card text-card-foreground shadow-sm hover:shadow-lg transition-all hover:border-primary/50"
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`size-12 rounded-lg bg-primary/10 flex items-center justify-center shrink-0 ${component.color}`}
                    >
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6">shadcn/ui란?</h2>
